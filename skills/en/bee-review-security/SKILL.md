---
name: bee-review-security
description: "[Cross-cutting skill] Always triggered in pair with bee-review-backend/frontend/database during code reviews. Checks authentication, authorization, encryption, and input validation. OAuth 2.1, Zero Trust, mTLS, OWASP countermeasures."
---
...
```
[SKILL_USED: bee-review-security]
```
