---
name: bee-review-database
description: Triggered for DB schema, query, and migration reviews. [Required pair: bee-review-security] Targets: SQL, ORM schema definitions, DB design docs (doc/design/database). PostgreSQL-centric.
---
...
```
[SKILL_USED: bee-review-database]
```
