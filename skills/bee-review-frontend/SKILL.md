---
name: bee-review-frontend
description: Triggered for frontend code and component design reviews. [Required pair: bee-review-security] Targets: React/Vue etc. (.tsx/.vue), frontend design docs (doc/design/frontend). Use bee-review-backend for backend, bee-review-database for DB.
---
...
```
[SKILL_USED: bee-review-frontend]
```
